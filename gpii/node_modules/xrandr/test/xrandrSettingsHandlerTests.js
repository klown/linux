...
jqUnit.test("Running tests for Xrandr Bridge", function () {
    ...
    //
    var methods = ["getScreenResolution", "getAvailableResolutions", "setScreenResolution", "get", "set"];
    for (var method in methods) {
        jqUnit.assertTrue("Checking availability of method '" + method + "'",
                          (methods[method] in xrandr));
    }

    // TODO:  any way to know what the available resolutions are to test
    // against? Also, what about multiple monitors?  Currrently the bridge
    // returns only information about one monitor.
    var availableReesolutions = xrandr.getAvailableResolutions();
    jqUnit.assertNotNull("Checking available resolutions", availableReesolutions);
